...
export class BaseProxy {
  ...
  protected async httpRequest ({url, method, header, body, query, isForm = false, skipLog = true}: { url: string, method: string, header?: object, body?: object, query?: object, isForm?: boolean, skipLog?: boolean }) {
  ...
  protected async post ({url, body, header, query, isForm, skipLog}: { url: string, body?: any, header?: object, query?: object, isForm?: boolean, skipLog?: boolean }) {
